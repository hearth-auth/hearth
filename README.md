...
> **Stable 1.6.6:** APIs and on-disk formats are stable. See [CHANGELOG](CHANGELOG.md) for the full release history.

---

## Install

Download pre-built v1.6.6 artifacts from the [Releases page](https://github.com/hearth-auth/hearth/releases/tag/v1.6.6), or use Docker or Helm.
...
curl -LO "https://github.com/hearth-auth/hearth/releases/download/v1.6.6/${ARTIFACT}"
...
```powershell
Invoke-WebRequest `
  -Uri "https://github.com/hearth-auth/hearth/releases/download/v1.6.6/hearth-windows-amd64.exe" `
  -OutFile hearth-windows-amd64.exe
Invoke-WebRequest `
  -Uri "https://github.com/hearth-auth/hearth/releases/download/v1.6.6/SHA256SUMS" `
  -OutFile SHA256SUMS
...
docker run --rm --network=host ghcr.io/hearth-auth/hearth:v1.6.6 serve --dev
